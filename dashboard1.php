                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="buy.php" class="btn btn-default btn-lg"> <i class="glyphicon glyphicon-shopping-cart"></i> <span class="network-name">Buy</span></a>
                            </li>
                            <li>
                                
                                <a href="sellnew.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-usd"></i> <span class="network-name">Sell</span></a>
                            </li>
                            <li>
                                <a href="rent.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-dashboard"></i> <span class="network-name">Rent</span></a>
                            </li>
                        </ul>
                    </div>
                </div>

...
function myFunction() 
{
   ...
   <!-- <div id="wrapper">
    ...
    function fn()
    {
        ...
        //document.getElementById('panel_head').innerHTML
        $.post('ppdata.php',{email:'harshvardhasingh58@gmail.com'},function(output){
 ...
 <script type="text/javascript" >
            function delete1(ob)
            {
                $.post('delete.php',{postid:ob.id},function(){
                    fn();
                }
                );
            }
